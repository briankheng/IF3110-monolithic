...
<style><?php include '../../public/css/pages/admin-user-edit.css'; ?></style>
...
<section id="edit-user">
    <div class="edit-user-container">
        ...
        <div class="edit-user-form-container">
            <form id="user-form" enctype="multipart/form-data" onsubmit="editUser(event)">
...
<script type="text/javascript" src="/../../public/js/admin-user-edit.js"></script>